...
const menuGroups = [
  {
    ...
    menuItems: [
      ...
      // },
      {
        ...
        route: "#",
        children: [
          { label: "Images", route: "/dashboard/uploads/images" },
          { label: "Videos", route: "/dashboard/uploads/videos" },
        ],
      },
      {
        icon:<FaVectorSquare size={24}/>,
        label:"Vectors",
        route:"/dashboard/vectors",
      },
      {
